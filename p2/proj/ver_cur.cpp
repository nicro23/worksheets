...
void draw_fixed(char x[][500], matrix mat, ldder ladder[], hill hills[], int ct_hills, lva lava)
{
    int i, j, k;
...
void cd(user& usr, bullts& bullet, platfrm& platform, katio& kat, ofu& ufo, mahmod& mahmoud)
{
    usr.jump_cd--;
    bullet.cd--;
    platform.cd--;
...
void animation(char x[][500], matrix& mat, user& usr, platfrm& platform, bullts& bullet, ldder ladder[], hill hills[], int ct_hills, lva lava, katio& kat, cest& chest, ofu& ufo, mahmod& mahmoud)
{
    //clear the matrix
    clear(x);
    ...
    cd(usr, bullet, platform, kat, ufo, mahmoud);
...
void gravity_and_jump(char x[][500], matrix& mat, user& usr, platfrm& platform, bullts& bullet, ldder ladder[], hill hills[], int ct_hills, lva lava, katio& kat, cest& chest, ofu& ufo,mahmod& mahmoud)
{
    // bynzl kam cell;
...
//must copy animation refrences[contains animation]
void user_action(char x[][500], char dir, user& usr, matrix& mat, platfrm& platform, bullts& bullet, ldder ladder[], hill hills[], int ct_hills, lva lava, katio& kat, cest& chest, ofu& ufo,mahmod& mahmoud)
{
    ...
    if (dir == 's' && usr.can_ladder_down == 1 && usr.r + 5 < 45 && usr.pause_getch == 0)
    {
        usr.r += usr.speed;
        //3shan lw taneitk days myzhrsh
        //old animation
